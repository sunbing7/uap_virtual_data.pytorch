...
from config.config import RESULT_PATH, MODEL_PATH, PROJECT_PATH, UAP_PATH, NEURON_PATH, UAPS_PATH, ATTRIBUTION_PATH
...
def get_uaps_path():
    if not os.path.isdir(UAPS_PATH):
        os.makedirs(UAPS_PATH)
    model_path = UAPS_PATH
    return model_path
