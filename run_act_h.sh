...
#TARGET_CLASS=214
#LAYER=43
for TARGET_CLASS in {150,214,39,527,65,693,771}
do
  ...
  do
    ...
    python analyze_input.py --option=entropy --causal_type=act --target_class=$TARGET_CLASS --num_iterations=32 --split_layer=$LAYER --ngpu=1 --workers=4

  done
done

#python analyze_input.py --option=entropy --causal_type=act --target_class=150 --num_iterations=32 --split_layer=43 --ngpu=1 --workers=4
python analyze_input.py --option=analyze_layers --analyze_clean=0 --causal_type=act --targeted=True --dataset=imagenet --arch=vgg19 --model_name=vgg19_imagenet.pth --split_layer=40 --seed=123 --num_iterations=32 --result_subfolder=result --target_class=150 --batch_size=32 --ngpu=1 --workers=4
python analyze_input.py --option=analyze_clean --causal_type=act --targeted=True --dataset=imagenet --arch=vgg19 --model_name=vgg19_imagenet.pth --seed=123 --num_iterations=50 --result_subfolder=result --target_class=150 --split_layer=40 --batch_size=32 --ngpu=1 --workers=4
python analyze_input.py --option=analyze_layers --analyze_clean=1 --causal_type=act --targeted=True --dataset=imagenet --arch=vgg19 --model_name=vgg19_imagenet.pth --seed=123 --num_iterations=50 --result_subfolder=result --target_class=150 --split_layer=40 --batch_size=32 --ngpu=1 --workers=4
python analyze_input.py --option=entropy --causal_type=act --target_class=150 --num_iterations=32 --split_layer=40 --ngpu=1 --workers=4