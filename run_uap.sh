...
#TARGET_CLASS=214
#LAYER=43
for TARGET_CLASS in {150,214}
#{214,39,527,65,639,771,150}
do
  ...
  do
    ...
    python analyze_input.py --option=classify --causal_type=act --target_class=$TARGET_CLASS --num_iterations=32 --split_layer=$LAYER --th=1.5
    rm attribution/uap_attribution_*.npy
    rm attribution/clean_attribution_*.npy
  done
done