...
python analyze_input.py --option=repair --dataset=imagenet --arch=vgg19 --model_name=vgg19_imagenet.pth --split_layers 28 19 --seed=123 --num_iterations=1000 --result_subfolder=result --batch_size=32 --ngpu=1 --workers=4 --alpha=0.1
