...
python test_uap_caffe.py --targeted=True --dataset=imagenet --pretrained_dataset=imagenet --test_name=googlenet_imagenet.pth --pretrained_arch=googlenet --pretrained_seed=123 --test_dataset=imagenet --test_arch=googlenet --result_subfolder=result --targeted=True --target_class=753 --ngpu=1 --workers=4
