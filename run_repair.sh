################################################################################################################################################
#resnet50
python analyze_input.py --option=repair_ae --dataset=imagenet --arch=resnet50 --model_name=resnet50_imagenet.pth --learning_rate=0.001 --split_layers 9 --seed=123 --num_iterations=1 --targeted=True --result_subfolder=result --batch_size=32 --num_batches=1500 --ngpu=1 --workers=4 --alpha=0.9 --ae_iter=5 --target_class=547
...
################################################################################################################################################
#googlenet
python analyze_input.py --option=repair_ae --dataset=imagenet --arch=googlenet --model_name=googlenet_imagenet.pth --learning_rate=0.001 --split_layers 17 --seed=123 --num_iterations=1 --targeted=True --result_subfolder=result --batch_size=32 --num_batches=1500 --ngpu=1 --workers=4 --alpha=0.9 --ae_iter=10 --target_class=753
...
################################################################################################################################################
#vgg19
python analyze_input.py --option=repair_ae --dataset=imagenet --arch=vgg19 --model_name=vgg19_imagenet.pth --learning_rate=0.001 --split_layers 43 --seed=123 --num_iterations=1 --targeted=True --result_subfolder=result --batch_size=32 --num_batches=1500 --ngpu=1 --workers=4 --alpha=0.9 --ae_iter=15 --target_class=150
...
################################################################################################################################################
#mobilenet asl
python analyze_input.py --option=repair_ae --dataset=asl --arch=mobilenet --model_name=mobilenet_asl.pth --learning_rate=0.001 --split_layers 3 --seed=123 --num_iterations=15 --targeted=True --result_subfolder=result --batch_size=32 --num_batches=101 --ngpu=1 --workers=4 --alpha=0.9 --ae_iter=10 --target_class=19
python analyze_input.py --option=repair_ae --dataset=asl --arch=mobilenet --model_name=mobilenet_asl_ae_repaired_15_10.pth --learning_rate=0.001 --split_layers 3 --seed=123 --num_iterations=5 --targeted=True --result_subfolder=result --batch_size=32 --num_batches=101 --ngpu=1 --workers=4 --alpha=0.9 --ae_iter=10 --target_class=19


#to test
python analyze_input.py --option=repair_ae --dataset=asl --arch=mobilenet --model_name=mobilenet_asl.pth --learning_rate=0.001 --split_layers 3 --seed=123 --num_iterations=20 --targeted=True --result_subfolder=result --batch_size=32 --num_batches=101 --ngpu=1 --workers=4 --alpha=0.9 --ae_iter=10 --target_class=19
################################################################################################################################################
#shufflenetv2 caltech
python analyze_input.py --option=repair_ae --dataset=caltech --arch=shufflenetv2 --model_name=shufflenetv2_caltech.pth --learning_rate=0.001 --split_layers 6 --seed=123 --num_iterations=2000 --targeted=True --result_subfolder=result --batch_size=32 --num_batches=10 --ngpu=1 --workers=4 --alpha=0.9 --ae_iter=10 --target_class=37
...
################################################################################################################################################
#resnet50 eurosat
python analyze_input.py --option=repair_ae --dataset=eurosat --arch=resnet50 --model_name=resnet50_eurosat.pth --learning_rate=0.005 --split_layers 9 --seed=123 --num_iterations=200 --targeted=True --result_subfolder=result --batch_size=32 --num_batches=34 --ngpu=1 --workers=4 --alpha=0.9 --ae_iter=10 --target_class=3
