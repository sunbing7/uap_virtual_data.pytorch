...
from utils.training import train, save_checkpoint, metrics_evaluate, solve_activation
...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Perform Activation Analysis')
    # pretrained
...
def main():
    ...
    neuron_ranking = solve_activation(data_train_loader, filter_network, uap, args.filter_arch,
                                    target_class=args.target_class,
    ...
    uap_fn = os.path.join(neuron_path, '_' + neuron_fn)
