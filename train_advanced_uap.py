...
from utils.training import train, save_checkpoint, metrics_evaluate, eval_uap, train_advanced
...
def parse_arguments():
    ...
    parser.add_argument('--adjust', default=5.0, type=float,
                        help='control the weight of entropy asjustment in loss function')
...
def main():
    ...
    start = time.time()
    train_advanced(data_loader=data_train_loader,
                   model=perturbed_net,
